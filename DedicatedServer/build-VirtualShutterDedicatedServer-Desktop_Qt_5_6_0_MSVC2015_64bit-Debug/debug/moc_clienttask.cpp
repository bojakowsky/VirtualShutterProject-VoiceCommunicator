...
#include "../../VirtualShutterDedicatedServer/logic/connection/clienttask.h"
...
QT_MOC_LITERAL(4, 31, 9) // "Structure"

    },
    "ClientTask\0Result\0\0std::string\0Structure"
};
...
void ClientTask::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ClientTask *_t = static_cast<ClientTask *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Result((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (ClientTask::*_t)(std::string );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClientTask::Result)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ClientTask::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ClientTask.data,
      qt_meta_data_ClientTask,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ClientTask::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ClientTask.stringdata0))
        return static_cast<void*>(const_cast< ClientTask*>(this));
    if (!strcmp(_clname, "QRunnable"))
        return static_cast< QRunnable*>(const_cast< ClientTask*>(this));
...
// SIGNAL 0
void ClientTask::Result(std::string _t1)
{
