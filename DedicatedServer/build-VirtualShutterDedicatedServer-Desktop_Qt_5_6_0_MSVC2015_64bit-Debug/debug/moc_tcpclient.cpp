...
#include "../../VirtualShutterDedicatedServer/logic/connection/tcpclient.h"
...
QT_MOC_LITERAL(5, 44, 10), // "TaskResult"
QT_MOC_LITERAL(6, 55, 11), // "std::string"
QT_MOC_LITERAL(7, 67, 9) // "Structure"

    },
    "TCPClient\0connected\0\0disconnected\0"
    "readyRead\0TaskResult\0std::string\0"
    "Structure"
};
...
void TCPClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->TaskResult((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
